 ...
 * @param {string} [encasing="[]"] Characters to encase text in. @returns {string} Padded and encased string.
 * @example padString(10, "*", "Title"); // Returns a padded string with "Title" centered and enclosed by "*" */
